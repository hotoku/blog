...
function convertMermaidTag() {
    ...
    codeNodes.forEach(function (codeNode, index) { return __awaiter(_this, void 0, void 0, function () {
        var pre, parent, child, graph;
        return __generator(this, function (_a) {
            pre = codeNode.parentNode;
            parent = pre.parentNode;
            child = document.createElement("div");
            child.id = "hotokuMermaidDiv-".concat(index);
            graph = mermaid__WEBPACK_IMPORTED_MODULE_0__/* ["default"].mermaidAPI.render */ .Z.mermaidAPI.render(child.id, codeNode.textContent);
